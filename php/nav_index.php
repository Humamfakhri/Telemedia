...
function nav_index($nama){
    $guest = "
        <link rel='stylesheet' href='php/nav_index2.css'>
        <link rel=\"stylesheet\" type=\"text/css\" href=\"bootstrap/css/bootnavbar_index.css\">
                    ...
                    <ul class=\"navbar-nav\">
                        ...
                        <li class=\"nav-item dropdown mr-3\">
                            <a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"navbarDropdown\" role=\"button\" 
                                data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">Harga Layanan</a>
    ...
    $tombol_guest = "
                    ...
                    <ul class=\"navbar-nav ml-auto\">
                        <li class=\"nav-item\">
                            <a href='Cart.php'>
                                <i class='fas fa-shopping-cart' style='margin-top: 8px;'></i>
                            </a>
                        </li>
                        <div class='vertical2' style='margin-right: 20px; margin-left: 20px; margin-top: 6px;'></div>
                        <li class='nav-item'>
    ...
    $tombol_logged = "
                    <ul class=\"navbar-nav ml-auto\">
                        <li class=\"nav-item mt-1\">
                            <a href='Cart.php' class='cart-nav row'>
                                <i class='fas fa-shopping-cart' style='margin-top: 8px;'></i>
                                <span id='cart_count' class='text-warning'>0</span>
                            </a>
                        </li>
                        
                        <div class='vertical2' style='margin-right: 30px; margin-left: 13px;'></div>
    ...
    ";
                            ...
                            if (!isset($_SESSION['LOGIN'])){
                                echo $guest, $nav_index, $tombol_guest;
                            }elseif(isset($_SESSION['LOGIN'])){
                                echo $logged, $nav_index, $tombol_logged;
                            }
