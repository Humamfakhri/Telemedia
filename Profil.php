...
<body>
		...
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item mr-2">
		        <a class="nav-link" href="Harga Layanan.php">Harga Layanan</a>
		      </li>
		      <li class="nav-item mr-2">
		...
		<div class="container">
		  ...
		  <a class="btn btn-primary btn-lg" href="Harga Layanan.php" role="button">Mulai Pesan</a>
		</div>
		</div>

		<!-- BERANDA -->
		<div class="container">
			<div class="jumbo_title"><strong>JASA PEMBUATAN WEBSITE DAN TOKO ONLINE</strong></div>
		</div>
